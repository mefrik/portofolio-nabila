...
const UploadImageSecond = (props) => {
    ...
    const handleAddImage = (event) =>{
        ...
        props.handleGetImageSecond(tempData)
        setIsHasImage(false)
     }
    ...
    <>
        <fieldset style={{borderRadius: "6px", border:"2px solid #DFDFDE", margin: 0, height:"100%"}}>
            ...
            <Grid item xs={12} container spacing={2}>
                <Grid item xs={3}>
                    <label htmlFor="contained-button-image2">
                        <Input accept="image/*" id="contained-button-image2" multiple type="file" onChange={handleAddImage}/>
                ...
                {selectedImage? 
                        <Grid item xs={'auto'}>
                            <ImageList sx={{ maxWidth: 250, maxHeight: 200, overflow:"hidden" }}>
                                <ImageListItem>
                                    <img 
                                        className='uploadimage-view-image2'
                                        alt="not found" 
...
export default UploadImageSecond